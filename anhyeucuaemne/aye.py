...
for i in range(n//2-1):
    for j in range(m):
        ...
        # condition for printing stars to XBINH upper line
...
for i in range(n//2-1, n):
    for j in range(m):
        ...
        # condition for printing XBINH
        elif i == n//2-1:
            
            half_length = len("XBINH") // 2  # Calculate half the length of "XBINH"
            center_pos = m // 2 - half_length  # Calculate the center position

            if center_pos <= j < center_pos + len("XBINH"):
                print("XBINH"[j - center_pos], end=" ")
            else:
                print(' ', end=" ")
